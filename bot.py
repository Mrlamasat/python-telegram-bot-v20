...
# إعدادات التسجيل لمتابعة الأخطاء في Railway
...
# --- دالة عرض الحلقة (مع أزرار الحلقات) ---
async def send_episode_details(client, chat_id, v_id):
    ...
    if not ep:
        return await client.send_message(chat_id, "❌ عذراً، لم يتم العثور على الحلقة.")
    ...
    try:
        ...
        # جلب جميع الحلقات التي تشترك في نفس البوستر
