...
# ==============================
# 1️⃣ استقبال الفيديوهات الجديدة
# ==============================
...
# ==============================
# 2️⃣ استقبال البوستر وربطه بالحلقة
# ==============================
...
async def publish(client, query):
    ...
    db_query(
        "INSERT INTO episodes (v_id, poster_id, title, ep_num, duration, quality) VALUES (%s,%s,%s,%s,%s,%s) "
...
async def start(client, message):
    ...
    buttons.append([InlineKeyboardButton("🍿 شـاهـد الـمـزيد", url=PUBLIC_CHANNELS[0])])
    ...
    try:
        ...
        await message.reply_text(f"⚠️ تأكد من إضافة البوت كأدمن في القناة.")
