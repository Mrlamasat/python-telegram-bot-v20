...
ADMIN_CHANNEL = -1003547072209       # رقم القناة
...
if not SESSION_STRING:
    raise ValueError("❌ USER_SESSION فارغ! ضع Session String في Variables")
...
app = Client(
    ...
    api_hash=API_HASH,
    workers=20,
    in_memory=True  # لتجنب مشاكل اسم الملف الطويل
)
...
# ==============================
# 4. أوامر الإدارة (رفع فيديو/بوستر/رقم حلقة)
# ==============================
