...
PUBLIC_CHANNELS = os.environ.get("PUBLIC_CHANNELS", "@RamadanSeries26,@MoAlmohsen").split(",")
...
# ==============================
# 1. استقبال الفيديوهات من القناة
# ==============================
...
async def on_video(client, message):
    ...
    await message.reply_text("✅ استلمت الفيديو.. أرسل البوستر الآن واكتب اسم المسلسل في وصف الصورة.")
...
async def publish(client, query):
    ...
    db_query(
        ...
        "SET title=EXCLUDED.title, ep_num=EXCLUDED.ep_num, poster_id=EXCLUDED.poster_id, quality=EXCLUDED.quality",
