...
SOURCE_CHANNEL = -1003547072209      # قناة الرفع (المخزن)
FORCE_SUB_CHANNEL = -1003790915936   # قناة الاشتراك الإجباري
FORCE_SUB_LINK = "https://t.me/+KyrbVyp0QCJhZGU8"
PUBLIC_POST_CHANNEL = -1003678294148 # قناة العرض (التي يراها المشتركون)
...
async def get_episodes_markup(title, current_v_id):
    ...
    full_share_url = f"https://t.me/share/url?url={share_link}&text={encoded_text}"
...
async def receive_ep_num(client, message):
    ...
    await message.reply_text(f"🚀 تم النشر بنجاح في قناة العرض بالحلقة رقم {ep_num}.")
